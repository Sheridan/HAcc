...
//! Если ты не знаешь для чего эта функция - тебе не место тут.
/**
  Инициализация синглтона с передачей коммандной строки и запуск приложения.
  Ожидание завершения и возврат кода завершения
*/
...
/**
  \mainpage Документация
    - \subpage transactions_types Типы транзакций
    - \subpage transactions_details Детали транзакций
*/

/**
\page transactions_types Типы транзакций
- Покупка
  - Пул:
...
- Внутренний перевод (пул всегда из 2 транзакций)
  - Пул:
...
- Продажа Приход, зарплата (пул всегда из 2 транзакций)
  - Пул:
...
*/
/**
\page transactions_details Детали транзакций
  - Покупка вещи:
